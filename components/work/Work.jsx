    ...
    <section className="relative mb-12 xl:mb-48">
      <div className="container mx-auto relative">
        ...
        <div className="max-w-full mx-auto text-center xl:text-left mb-12 xl:h-[400] flex flex-col justify-center items-center xl:items-start">
          ...
          Showcasing my most recent projects, each reflecting advanced web development skills and a commitment to creating responsive, user-friendly, and high-quality digital experiences.
          </p>
          <Link href="/projects">
